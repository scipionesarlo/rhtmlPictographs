...
//
// describe.only('GraphicCell class', function () {
...
//         const g = new GraphicCell()
//         expect(() => g.setWidth(0)).to.throw(new RegExp(/width/))
//         expect(() => g.setHeight(0)).to.throw(new RegExp(/height/))
//       })
//     })
//
...
//
//       this.instance.setPictographSizeInfo({ ratios: { textSize: 1 } })
//
