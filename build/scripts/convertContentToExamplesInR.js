...
const loadDemoFile = function(relativePathToContentFile) {
...
const processAndSaveDemo = function({ contentName, content }) {
  ...
  sections.each(function() {
    ...
    examples.each(function() {
      ...
      return rFileContents.push("rhtmlPictographs::graphic('" + exampleConfig + "')");
    });
...
const saveContents = function({ destination, content }) {
...
const ensureDirectoryExists = function(directory) {
  return new Promise((resolve, reject) => {
